    ...
    <div className="page">
      ...
      <div className="page-content" style={{ padding: "0 0 24px" }}>
        {isInProgress && !hasDestCoords ? (
          ...
          <MapView center={mapCenter} zoom={mapZoom} pins={mapPins} height={220} />
        )}

        {/* Pending: waiting for offers */}
        {isPending && (
          <>
            <h3 style={{ fontSize: "15px", fontWeight: 700, marginBottom: "12px" }} className="mt-2">
        ...
        {/* Active driver card — right below the map, before summary */}
        ...
        <div style={{ padding: "0 16px" }}>
          ...
          {/* Cancel option — only before trip starts */}
